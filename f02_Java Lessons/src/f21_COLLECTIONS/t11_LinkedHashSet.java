...
/* Класс LinkedHashSet – это HashSet, в котором элементы хранятся еще и в связном списке. 
 ...
 А у LinkedHashSet можно получить итератор и с его помощью обойти все элементы именно в том порядке, в котором они добавлялись в 
 LinkedHashSet. Не часто, но иногда это может очень понадобится.
	Иерархия класса LinkedHashSet
	Наследует: класс AbstractCollection - класс AbstractSet - класс HashSet - класс LinkedHashSet
	Реализует: интерфейс Iterable - интерфейс Collection - интерфейс Set
...
public class t11_LinkedHashSet {
