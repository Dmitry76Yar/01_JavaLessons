...
//			graph.matrizaEdgeOptions[finishCountry][startCountry] = new Edge();
//			graph.matrizaEdgeOptions[finishCountry][startCountry].addEdge(departureTime, arrivalTime);
		}
		else {
			graph.matrizaEdgeOptions[startCountry][finishCountry].addEdge(departureTime, arrivalTime);
//			graph.matrizaEdgeOptions[finishCountry][startCountry].addEdge(departureTime, arrivalTime);
...
//		graph.matrizaSmegnosti[finishCountry][startCountry] =  1;
	}
